        ...
        {resume.education.map((edu, index) => (
          <div key={index} style={styles.card}>
            ...
            <div style={styles.rightColumn}>
              ...
              <p style={styles.details}>CGPA: {edu.cgpa}</p>
            </div>
          </div>
        ))}
          ...
          <div style={styles.skillsGrid}>
            <div style={styles.skillCategory}>
              <ul style={styles.skillList}>
                {skills.programming.map((skill, i) => <li key={i} style={styles.skillItem}>▪ {skill}</li>)}
              </ul>
            </div>
            <div style={styles.skillCategory}>
              <ul style={styles.skillList}>
                {skills.webDevelopment.map((skill, i) => <li key={i} style={styles.skillItem}>▪ {skill}</li>)}
              </ul>
            </div>
            <div style={styles.skillCategory}>
              <ul style={styles.skillList}>
                {skills.database.map((skill, i) => <li key={i} style={styles.skillItem}>▪ {skill}</li>)}
              </ul>
            </div>
            <div style={styles.skillCategory}>
              <ul style={styles.skillList}>
                {skills.tools.map((skill, i) => <li key={i} style={styles.skillItem}>▪ {skill}</li>)}
              </ul>
            </div>
          </div>
        </div>
